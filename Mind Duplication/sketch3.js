...
function draw() {
    ...
    for (let i = 0; i < 9; i++) {
        for (let j = 0; j < 5; j++) {
            ...
            image(buffers[i + j*n].img, i*windowHeight/n, j*windowHeight/n, windowHeight/n, windowHeight/n);
        }
    }
...
function drawRock(piece, buffer) {
    ...
    buffer.img.curveVertex((x + (right + 1) + 0.5)*cellSize, (y + 0.5)*cellSize);
    buffer.img.curveVertex((x + 0.5)*cellSize, (y + (down + 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x + (left - 1) + 0.5)*cellSize, (y + 0.5)*cellSize);
...
function drawQueen(piece, buffer) {
    ...
    buffer.img.beginShape();
    buffer.img.curveVertex((x + 0.5)*cellSize, (y + (up - 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x - (upRight - 1) + 0.5)*cellSize, (y + (upRight - 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x + (right + 1) + 0.5)*cellSize, (y + 0.5)*cellSize);
    buffer.img.curveVertex((x + (rightDown + 1) + 0.5)*cellSize, (y + (rightDown + 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x + 0.5)*cellSize, (y + (down + 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x - (downLeft + 1) + 0.5)*cellSize, (y + (downLeft + 1) + 0.5)*cellSize);
    buffer.img.curveVertex((x + (left - 1) + 0.5)*cellSize, (y + 0.5)*cellSize);
    buffer.img.curveVertex((x + (leftUp - 1) + 0.5)*cellSize, (y + (leftUp - 1) + 0.5)*cellSize);
    buffer.img.endShape(CLOSE);
...
function drawPawn(piece, buffer) {
    ...
    if (piece.pieceColor == "W") {
        buffer.img.fill(random(whiteColor));
        buffer.img.beginShape();
        buffer.img.curveVertex((piece.pos.x + 0.5)*cellSize, (piece.pos.y + 0.5)*cellSize);
        buffer.img.curveVertex((piece.pos.x + 1.5)*cellSize, (piece.pos.y - 0.5)*cellSize);
        buffer.img.curveVertex((piece.pos.x - 0.5)*cellSize, (piece.pos.y - 0.5)*cellSize);
        buffer.img.endShape(CLOSE);
        ...
        buffer.img.beginShape();
        buffer.img.curveVertex((piece.pos.x + 0.5)*cellSize, (piece.pos.y + 0.5)*cellSize);
        buffer.img.curveVertex((piece.pos.x + 1.5)*cellSize, (piece.pos.y + 1.5)*cellSize);
        buffer.img.curveVertex((piece.pos.x - 0.5)*cellSize, (piece.pos.y + 1.5)*cellSize);
        buffer.img.endShape(CLOSE);
